...
#define MY_SSID "NEKA"       // replace by the name of your access point (when act as station) or the name you assign to your device (when act as acces point)
...
#define MY_PASSWORD "neka1984" // replace by your password 
...
#define GRBL_BT_NAME "neka-simple_grbl"   // name of GRBL_ESP32 bluetooth device (as defined in GRBL_ESP32)
